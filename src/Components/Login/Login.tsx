                                ...
                                <div className="row">
                                    <div className="btn-rainbow-card mx-auto text-center col-md-6 col-12">
                                        <div className="py-4 px-sm-0 px-md-12 text-center ">
                                            ...
                                            <form action="#" data-hs-cf-bound="true"><input name="email" className="form-control mt-6" placeholder="E-Posta" /><input name="password" className="form-control mt-6" type="password" placeholder="Şifre" /><button className="btn btn-light w-100 mt-6"  style={{backgroundColor:'#A628FF', color:'#fff', minWidth: '200px',
                                            lineHeight: '18px', borderRadius:'20px', fontWeight:'bold'
                                            }}>Giriş Yap</button><label><small>
