...
const FooterPlatform = (props: Props) => {
  return (
    <section className="bg-footerpurple py-1">
      <div className="container">
        <div className="row justify-content-between align-items-center">
          <div className="col-6 col-lg-4 mb-lg-0 my-4">
            <Link className="d-block mobile-text-center navbar-brand" to="#">
              <span
                style={{
              ...
              >
                ...
                <img
                  alt=""
                  srcSet="https://tobeto.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTebeto-logo-yatay-beyaz.8c2d6927.png&w=128&q=75  1x,https://tobeto.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FTebeto-logo-yatay-beyaz.8c2d6927.png&w=256&q=75  2x"
