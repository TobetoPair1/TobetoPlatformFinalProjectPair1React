        ...
        <div className=" mx-auto text-center">
          <div className="py-4 px-md-12 px-0 text-center">
            ...
            <form data-hs-cf-bound="true">
              <h3 className="mt-6 mb-8">Hemen Kayıt Ol</h3><input name="firstName" className="form-control mt-6" type="text" placeholder="Ad*" /><input name="lastName" className="form-control mt-6" type="text" placeholder="Soyad*" /><input name="email" className="form-control mt-6" type="email" placeholder="E-Posta*" /><input name="password" className="form-control mt-6" type="password" placeholder="Şifre*" /><input name="passwordAgain" className="form-control mt-6" type="password" placeholder="Şifre Tekrar*" />
            </form><button disabled className="btn btn-primary w-100 mt-6">Kayıt Ol</button>
