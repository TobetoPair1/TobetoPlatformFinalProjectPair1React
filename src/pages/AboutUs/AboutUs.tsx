        ...
        <div className='container'>
          <div className='row mt-10'>
            <div className='col-12'>
              ...
              <p className='about-paragraph'>
                ...
                kazanması hem de genç profesyonellerin, ihtiyaçlarına uygun
                olarak yenilenmeleri ve yetkinliklerini geliştirmelerini
              ...
              <p className='about-paragraph'>
                ...
                Kurum içi çözümlere destek veriyor, eğitim ve istihdam arasında
          ...
          <div className='row mt-10'>
            <div className='bg-gradient-gray'>
              ...
              <span className='my-10' style={{ fontWeight: 600 }}>
                Danışma Kurulu
              </span>
              <div className='craws'>
                <div className='craw'>
