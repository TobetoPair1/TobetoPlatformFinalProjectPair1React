...
import EducationCourseCart from "../../Components/EducationCourseCart/EducationCourseCart";
...
const EducationPage = (props: Props) => {
  const platform: PlatformModel = useSelector((state: any) => state.platform);
    ...
    async function GetCourses() {
      setCourses((await CourseService.GetListByUserId({PageIndex:0,PageSize:100},platform?.user?.id)).data)
    }
    useEffect(()=>{
        GetCourses();
      },[])
                    ...
                    <div className="row mt-3">
                        ...
                        <div className="col-12">
                            <div className="tab-content" id="myTabContent">
                                ...
                                >
                                    <div className="row">
                                       <EducationCourseCart courses={courses as Paginate<CourseGetListResponseModel>}/>
                                    </div>
                                </div>
                                <div
