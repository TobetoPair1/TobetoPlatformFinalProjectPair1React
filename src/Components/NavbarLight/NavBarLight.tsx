...
const NavBarLight = (props: Props) => {
  ...
  const OnClickCanvasProfileButton = () => {
    setCanvasOpenButton(!openCanvasProfileButton);
  };
      ...
      <div className='container-fluid'>
        ...
        <ul className='d-none d-xxl-flex navbar-nav'>
          <li className='nav-item'>
            <Link
              className={
                'nav-link ' + (path == '/platform' ? 'nav-active' : 'c-gray-3')
              }
              to='/platform'
            >
              Ana Sayfa
          ...
          <li className='nav-item'>
            <Link
              className={
                'nav-link ' + (path == '/profilim' ? 'nav-active' : 'c-gray-3')
              }
              to='/profilim'
            >
              Profilim
          ...
          <li className='nav-item'>
            <Link
              className={
                'nav-link ' +
                (path == '/degerlendirmeler' ? 'nav-active' : 'c-gray-3')
              }
              to='/degerlendirmeler'
            >
              Değerlendirmeler
          ...
          <li className='nav-item'>
            <Link
              className={
                'nav-link ' + (path == '/takvim' ? 'nav-active' : 'c-gray-3')
              }
              to='/takvim'
            >
              Takvim
          ...
          <li className='nav-item'>
            <Link
              className={
                'nav-link ' +
                (path == '/istanbul-kodluyor' ? 'nav-active' : 'c-gray-3')
              }
          ...
          <div className='d-flex justify-space-between align-items-center'>
            ...
            <div className='btn-group header-avatar'>
              <button
                type='button'
                className={
                  'btn p-0 fw-normal b-r-35 text-end d-flex align-items-center ' +
                  (openProfileButton ? 'show' : '')
                }
              ...
              <ul
                className={
                  'profile dropdown-menu ' + (openProfileButton ? 'show' : '')
                }
              >
                <li>
                  <Link
          ...
          <div className='mt-auto '>
            ...
            <div className='py-6'>
              <div className='btn-group header-avatar w-100'>
                ...
                >
                  <div className='me-3'>
                    <p className='mb-0 small c-gray-3'>
                      {user.firstName + ' ' + user.lastName}
                    </p>
                  </div>
                  <div className='me-2'>
